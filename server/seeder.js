...
const importData = async () => {
  try {
    ...
    const products = [
      { id: '65f6c82a7a4b1c2d3e4f5a6b', name: 'Handcrafted Wooden Bowl', price: 25.00, imageUrl: 'https://placehold.co/300x200/E0E7FF/4338CA?text=Wooden+Bowl', rating: 4.5, numReviews: 10, category: 'Decor' },
      ...
      { id: '65f6c82a7a4b1c2d3e4f5a6d', name: 'Ceramic Mug', price: 18.00, imageUrl: 'https://placehold.co/300x200/FEE2E2/991B1B?text=Ceramic+Mug', rating: 4.2, numReviews: 8, category: 'Decor' },
      ...
      { id: '65f6c82a7a4b1c2d3e4f5a6f', name: 'Artisanal Soap Set', price: 15.00, imageUrl: 'https://placehold.co/300x200/DBEAFE/1E40AF?text=Artisanal+Soap', rating: 4.6, numReviews: 12, category: 'Essentials' },
      ...
      { id: '65f6c82a7a4b1c2d3e4f5a71', name: 'Scented Soy Candle', price: 12.50, imageUrl: 'https://placehold.co/300x200/F0F8FF/4682B4?text=Soy+Candle', rating: 4.7, numReviews: 10, category: 'Essentials' },
      ...
      { id: '65f6c82a7a4b1c2d3e4f5a73', name: 'Macrame Wall Hanging', price: 60.00, imageUrl: 'https://placehold.co/300x200/F5FFFA/3CB371?text=Wall+Hanging', rating: 4.6, numReviews: 12, category: 'Decor' },
      ...
      { id: '65f6c82a7a4b1c2d3e4f5a76', name: 'Embroidered Throw Pillow', price: 30.00, imageUrl: 'https://placehold.co/300x200/F0FFFF/00CED1?text=Throw+Pillow', rating: 4.7, numReviews: 18, category: 'Decor' },
    ];
